        ...
        <div class="menu-block customscroll">
            <div class="sidebar-menu">
                <ul id="accordion-menu">
                    ...
                    <li>
                        <a href="{{ route('admin.manage-categories.cat-subcats-list')}}" class="dropdown-toggle no-arrow {{ Route::is('admin.manage-categories.*') ? 'active' : '' }} ">
                    ...
                    <li class="dropdown ">
							...
							<ul class="submenu">
                                ...
                                class="{{Route::is('seller.product.all-products') ? 'active' : '' }}">All Products</a></li>
